...
export function RatingStarIcon({ filled, className = '' }: { filled: boolean; className?: string }) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill={filled ? 'var(--color-star-filled)' : 'none'}
        stroke={filled ? 'var(--color-star-filled)' : 'var(--color-star-empty)'}
        strokeWidth="1.5"
